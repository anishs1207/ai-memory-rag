...
contextBridge.exposeInMainWorld('electron', {
  ...
  claudeWebPlan: (goal: string) => ipcRenderer.invoke('claude-web-plan', goal),
  claudeWebResearch: (goal: string, plannedTracks?: string[]) => ipcRenderer.invoke('claude-web-research', goal, plannedTracks),
  planBrowserActions: (goal: string, pageUrl: string, pageSnapshot: string) => ipcRenderer.invoke('browser-plan-actions', goal, pageUrl, pageSnapshot),
